        ...
        {hex.explored ? (
          <>
            ...
            <div>
              ...
              {ownerPlayer ? (
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 rounded flex items-center justify-center text-xs" style={{ backgroundColor: ownerPlayer.colorHex + '30', border: `1px solid ${ownerPlayer.colorHex}` }}>{ownerPlayer.emblem}</div>
            ...
            <div>
              ...
              <div className="text-sm text-gray-300 space-y-0.5">
                ...
                {!terrainData?.waterMod && !terrainData?.mineralMod && !terrainData?.energyMod && <p className="text-gray-500">{t.general.none}</p>}
              </div>
            </div>
            ...
            <div className="space-y-1.5 pt-2">
              ...
              {actionMode === 'claim' && hex.explored && hex.owner === null && (
                <button onClick={() => claimHex(hexKey)} disabled={gameState.actionPoints <= 0 || player.resources.credits < 2 || player.resources.energy < 1}
